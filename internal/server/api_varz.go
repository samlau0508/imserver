...
import (
	...
	"github.com/samlau0508/imserver/pkg/pse"
...
func CreateVarz(s *Server) *Varz {
	...
	return &Varz{
		...
		MonitorOn:      okutil.BoolToInt(opts.Monitor.On),
		Commit:         version.Commit,
		CommitDate:     version.CommitDate,
		TreeState:      version.TreeState,
		ManagerUID:     opts.ManagerUID,
		ManagerTokenOn: okutil.BoolToInt(opts.ManagerTokenOn),
	}
}
