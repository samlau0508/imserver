...
func (l *Proto) DecodePacketWithConn(conn io.Reader, version uint8) (Frame, error) {
...
// DecodePacket 解码包
func (l *Proto) DecodeFrame(data []byte, version uint8) (Frame, int, error) {
...
// EncodePacket 编码包
func (l *Proto) EncodeFrame(frame Frame, version uint8) ([]byte, error) {
...
func (l *Proto) encodeFrame(f Frame, enc *Encoder, remainingLength uint32) {
...
func (l *Proto) encodeFramer(f Frame, remainingLength uint32) ([]byte, error) {
...
func (l *Proto) decodeFramer(data []byte) (Framer, int, error) {
	typeAndFlags := data[0]
...
func (l *Proto) decodeFramerWithConn(conn io.Reader) (Framer, error) {
	b := make([]byte, 1)
